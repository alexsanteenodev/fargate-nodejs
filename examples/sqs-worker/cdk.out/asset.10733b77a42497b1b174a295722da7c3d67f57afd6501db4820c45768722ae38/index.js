...
var require_dist_cjs5 = __commonJS({
  "node_modules/@aws-sdk/middleware-recursion-detection/dist-cjs/index.js"(exports2) {
    ...
    Object.keys(recursionDetectionMiddleware).forEach(function(k4) {
      if (k4 !== "default" && !Object.prototype.hasOwnProperty.call(exports2, k4))
        Object.defineProperty(exports2, k4, {
          enumerable: true,
          get: function() {
...
function __generator(thisArg, body) {
  ...
  function step(op2) {
    ...
    while (g4 && (g4 = 0, op2[0] && (_ = 0)), _)
      try {
        if (f4 = 1, y2 && (t4 = op2[0] & 2 ? y2["return"] : op2[0] ? y2["throw"] || ((t4 = y2["return"]) && t4.call(y2), 0) : y2.next) && !(t4 = t4.call(y2, op2[1])).done)
          return t4;
        if (y2 = 0, t4)
...
function __importStar(mod) {
  ...
  var result = {};
  if (mod != null) {
    for (var k4 = ownKeys(mod), i4 = 0; i4 < k4.length; i4++)
      if (k4[i4] !== "default")
        __createBinding(result, mod, k4[i4]);
  }
  ...
  "node_modules/tslib/tslib.es6.mjs"() {
    ...
    ownKeys = function(o4) {
      ownKeys = Object.getOwnPropertyNames || function(o5) {
        var ar = [];
        for (var k4 in o5)
          if (Object.prototype.hasOwnProperty.call(o5, k4))
            ar[ar.length] = k4;
        return ar;
      };
      return ownKeys(o4);
...
var require_dist_cjs20 = __commonJS({
  "node_modules/@aws-sdk/middleware-sdk-sqs/dist-cjs/index.js"(exports2) {
    "use strict";
    var smithyClient = require_dist_cjs19();
      ...
      return (next, context) => {
        return async (args) => {
          ...
          if (!endpoint && input.QueueUrl && resolvedEndpoint && useQueueUrlAsEndpoint) {
            const logger2 = context.logger instanceof smithyClient.NoOpLogger || !context.logger?.warn ? console : context.logger;
            try {
              const queueUrl2 = new URL(input.QueueUrl);
              const queueUrlOrigin = new URL(queueUrl2.origin);
...
Set [endpoint=string] or [useQueueUrlAsEndpoint=false] on the SQSClient.`);
    ...
    exports2.getQueueUrlPlugin = getQueueUrlPlugin;
    exports2.getReceiveMessagePlugin = getReceiveMessagePlugin;
    exports2.getSendMessageBatchPlugin = getSendMessageBatchPlugin;
    exports2.getSendMessagePlugin = getSendMessagePlugin;
    exports2.queueUrlMiddleware = queueUrlMiddleware;
    exports2.queueUrlMiddlewareOptions = queueUrlMiddlewareOptions;
    exports2.receiveMessageMiddleware = receiveMessageMiddleware;
    exports2.receiveMessageMiddlewareOptions = receiveMessageMiddlewareOptions;
    exports2.resolveQueueUrlConfig = resolveQueueUrlConfig;
    exports2.sendMessageBatchMiddleware = sendMessageBatchMiddleware;
    exports2.sendMessageBatchMiddlewareOptions = sendMessageBatchMiddlewareOptions;
    exports2.sendMessageMiddleware = sendMessageMiddleware;
    exports2.sendMessageMiddlewareOptions = sendMessageMiddlewareOptions;
  }
});
...
var import_util_middleware3, httpAuthSchemeMiddleware;
...
var init_getHttpAuthSchemePlugin = __esm({
  "node_modules/@smithy/core/dist-es/middleware-http-auth-scheme/getHttpAuthSchemePlugin.js"() {
    import_middleware_serde = __toESM(require_dist_cjs21());
    init_httpAuthSchemeMiddleware();
...
var import_protocol_http6, import_util_middleware4, defaultErrorHandler, defaultSuccessHandler, httpSigningMiddleware;
...
var require_dist_cjs24 = __commonJS({
  "node_modules/@smithy/url-parser/dist-cjs/index.js"(exports2) {
    "use strict";
    var querystringParser = require_dist_cjs23();
    var parseUrl4 = (url) => {
...
var require_dist_cjs25 = __commonJS({
  "node_modules/@aws-sdk/util-endpoints/dist-cjs/index.js"(exports2) {
    ...
    var urlParser = require_dist_cjs24();
...
var require_fxp = __commonJS({
  "node_modules/fast-xml-parser/lib/fxp.cjs"(exports2, module2) {
    (() => {
      ...
      var t4 = { d: (e5, i5) => {
        for (var n5 in i5)
          t4.o(i5, n5) && !t4.o(e5, n5) && Object.defineProperty(e5, n5, { enumerable: true, get: i5[n5] });
          ...
          if ("<" === t5[o5] && "?" === t5[o5 + 1]) {
            ...
            }
            {
              ...
              }
              {
                ...
                const c5 = f4(t5, o5);
                if (false === c5)
                  return x4("InvalidAttr", "Attributes for '" + p5 + "' have open quote.", b4(t5, o5));
                let N2 = c5.value;
                if (o5 = c5.index, "/" === N2[N2.length - 1]) {
                  ...
                  const s6 = g4(N2, e5);
                  if (true !== s6)
                    return x4(s6.err.code, s6.err.msg, b4(t5, i6 + s6.err.line));
                  n5 = true;
                } else if (d5) {
                  if (!c5.tagClosed)
                    return x4("InvalidTag", "Closing tag '" + p5 + "' doesn't have proper closing.", b4(t5, o5));
                  if (N2.trim().length > 0)
                    return x4("InvalidTag", "Closing tag '" + p5 + "' can't have attributes or invalid starting.", b4(t5, a5));
                  if (0 === i5.length)
                    return x4("InvalidTag", "Closing tag '" + p5 + "' has not been opened.", b4(t5, a5));
                  {
                    const e6 = i5.pop();
                    if (p5 !== e6.tagName) {
                  ...
                  const r5 = g4(N2, e5);
                  if (true !== r5)
                    return x4(r5.err.code, r5.err.msg, b4(t5, o5 - N2.length + r5.err.line));
                  if (true === s5)
                    return x4("InvalidXml", "Multiple possible root nodes found.", b4(t5, o5));
                  -1 !== e5.unpairedTags.indexOf(p5) || i5.push({ tagName: p5, tagStartPos: a5 }), n5 = true;
                }
                for (o5++; o5 < t5.length; o5++)
                  if ("<" === t5[o5]) {
                    if ("!" === t5[o5 + 1]) {
                      o5++, o5 = h4(t5, o5);
                      continue;
                    ...
                    if ("?" !== t5[o5 + 1])
                      break;
                    if (o5 = u4(t5, ++o5), o5.err)
                      return o5;
                  } else if ("&" === t5[o5]) {
                    const e6 = m4(t5, o5);
                    if (-1 == e6)
                      return x4("InvalidChar", "char '&' is not expected.", b4(t5, o5));
                    o5 = e6;
                  } else if (true === s5 && !l4(t5[o5]))
                    return x4("InvalidXml", "Extra text at the end", b4(t5, o5));
                "<" === t5[o5] && o5--;
              }
            }
          }
      ...
      function u4(t5, e5) {
        ...
        for (; e5 < t5.length; e5++)
          if ("?" != t5[e5] && " " != t5[e5])
            ...
            if (e5 > 5 && "xml" === n5)
              return x4("InvalidXml", "XML declaration allowed only at the start of the document.", b4(t5, e5));
            if ("?" == t5[e5] && ">" == t5[e5 + 1]) {
              e5++;
              break;
            }
      ...
      function h4(t5, e5) {
        if (t5.length > e5 + 5 && "-" === t5[e5 + 1] && "-" === t5[e5 + 2]) {
          for (e5 += 3; e5 < t5.length; e5++)
            if ("-" === t5[e5] && "-" === t5[e5 + 1] && ">" === t5[e5 + 2]) {
              e5 += 2;
              break;
            }
        } else if (t5.length > e5 + 8 && "D" === t5[e5 + 1] && "O" === t5[e5 + 2] && "C" === t5[e5 + 3] && "T" === t5[e5 + 4] && "Y" === t5[e5 + 5] && "P" === t5[e5 + 6] && "E" === t5[e5 + 7]) {
          let i5 = 1;
          for (e5 += 8; e5 < t5.length; e5++)
            if ("<" === t5[e5])
              i5++;
            else if (">" === t5[e5] && (i5--, 0 === i5))
              break;
      ...
      function f4(t5, e5) {
        let i5 = "", n5 = "", s5 = false;
        for (; e5 < t5.length; e5++) {
          if (t5[e5] === d4 || t5[e5] === p4)
            "" === n5 ? n5 = t5[e5] : n5 !== t5[e5] || (n5 = "");
          else if (">" === t5[e5] && "" === n5) {
            s5 = true;
            break;
          }
      ...
      function g4(t5, e5) {
        ...
        for (let t6 = 0; t6 < i5.length; t6++) {
          if (0 === i5[t6][1].length)
            return x4("InvalidAttr", "Attribute '" + i5[t6][2] + "' has no space in starting.", E2(i5[t6]));
          if (void 0 !== i5[t6][3] && void 0 === i5[t6][4])
            return x4("InvalidAttr", "Attribute '" + i5[t6][2] + "' is without value.", E2(i5[t6]));
          if (void 0 === i5[t6][3] && !e5.allowBooleanAttributes)
            return x4("InvalidAttr", "boolean attribute '" + i5[t6][2] + "' is not allowed.", E2(i5[t6]));
          const s5 = i5[t6][2];
          if (!N(s5))
            return x4("InvalidAttr", "Attribute '" + s5 + "' is an invalid name.", E2(i5[t6]));
          if (n5.hasOwnProperty(s5))
            return x4("InvalidAttr", "Attribute '" + s5 + "' is repeated.", E2(i5[t6]));
          n5[s5] = 1;
        }
        return true;
      }
      function m4(t5, e5) {
        ...
        let i5 = 0;
        for (; e5 < t5.length; e5++, i5++)
          if (!(t5[e5].match(/\w/) && i5 < 20)) {
            if (";" === t5[e5])
              break;
            return -1;
          }
      ...
      class w4 {
        ...
        readDocType(t5, e5) {
          const i5 = {};
          if ("O" !== t5[e5 + 3] || "C" !== t5[e5 + 4] || "T" !== t5[e5 + 5] || "Y" !== t5[e5 + 6] || "P" !== t5[e5 + 7] || "E" !== t5[e5 + 8])
            throw new Error("Invalid Tag instead of DOCTYPE");
          {
            ...
            for (; e5 < t5.length; e5++)
              if ("<" !== t5[e5] || r5)
                if (">" === t5[e5]) {
                  if (r5 ? "-" === t5[e5 - 1] && "-" === t5[e5 - 2] && (r5 = false, n5--) : n5--, 0 === n5)
                    break;
                } else
                  "[" === t5[e5] ? s5 = true : o5 += t5[e5];
              else {
        ...
        readEntityExp(t5, e5) {
          ...
          if (O(i5), e5 = I2(t5, e5), !this.suppressValidationErr) {
            if ("SYSTEM" === t5.substring(e5, e5 + 6).toUpperCase())
        ...
        readNotationExp(t5, e5) {
          ...
          if (!this.suppressValidationErr && "SYSTEM" !== n5 && "PUBLIC" !== n5)
            throw new Error(`Expected SYSTEM or PUBLIC, found "${n5}"`);
          e5 += n5.length, e5 = I2(t5, e5);
          let s5 = null, r5 = null;
          if ("PUBLIC" === n5)
            [e5, s5] = this.readIdentifierVal(t5, e5, "publicIdentifier"), '"' !== t5[e5 = I2(t5, e5)] && "'" !== t5[e5] || ([e5, r5] = this.readIdentifierVal(t5, e5, "systemIdentifier"));
          else if ("SYSTEM" === n5 && ([e5, r5] = this.readIdentifierVal(t5, e5, "systemIdentifier"), !this.suppressValidationErr && !r5))
        ...
        readIdentifierVal(t5, e5, i5) {
          ...
          const s5 = t5[e5];
          if ('"' !== s5 && "'" !== s5)
            throw new Error(`Expected quoted string, found "${s5}"`);
          for (e5++; e5 < t5.length && t5[e5] !== s5; )
            n5 += t5[e5], e5++;
          if (t5[e5] !== s5)
            throw new Error(`Unterminated ${i5} value`);
          return [++e5, n5];
        }
        readElementExp(t5, e5) {
          ...
          for (; e5 < t5.length && !/\s/.test(t5[e5]); )
            i5 += t5[e5], e5++;
          if (!this.suppressValidationErr && !r4(i5))
            throw new Error(`Invalid element name: "${i5}"`);
          let n5 = "";
          if ("E" === t5[e5 = I2(t5, e5)] && P(t5, "MPTY", e5))
            e5 += 4;
          else if ("A" === t5[e5] && P(t5, "NY", e5))
            e5 += 2;
          else if ("(" === t5[e5]) {
            ...
            throw new Error(`Invalid Element Expression, found "${t5[e5]}"`);
        ...
        readAttlistExp(t5, e5) {
          ...
          for (; e5 < t5.length && !/\s/.test(t5[e5]); )
            n5 += t5[e5], e5++;
          if (!O(n5))
            throw new Error(`Invalid attribute name: "${n5}"`);
          e5 = I2(t5, e5);
          let s5 = "";
          if ("NOTATION" === t5.substring(e5, e5 + 8).toUpperCase()) {
            if (s5 = "NOTATION", "(" !== t5[e5 = I2(t5, e5 += 8)])
              throw new Error(`Expected '(', found "${t5[e5]}"`);
            e5++;
            let i6 = [];
            for (; e5 < t5.length && ")" !== t5[e5]; ) {
              ...
              for (; e5 < t5.length && "|" !== t5[e5] && ")" !== t5[e5]; )
                n6 += t5[e5], e5++;
              if (n6 = n6.trim(), !O(n6))
                throw new Error(`Invalid notation name: "${n6}"`);
            ...
            if (!this.suppressValidationErr && !i6.includes(s5.toUpperCase()))
              throw new Error(`Invalid attribute type: "${s5}"`);
          }
          e5 = I2(t5, e5);
          let r5 = "";
      ...
      function $(t5) {
        return "function" == typeof t5 ? t5 : Array.isArray(t5) ? (e5) => {
          for (const i5 of t5) {
            if ("string" == typeof i5 && e5 === i5)
              return true;
            if (i5 instanceof RegExp && i5.test(e5))
              return true;
          }
        } : () => false;
      }
      ...
      function k4(t5, e5) {
        if (true !== this.options.ignoreAttributes && "string" == typeof t5) {
          ...
          for (let t6 = 0; t6 < n5; t6++) {
            ...
            if (this.ignoreAttributesFn(n6, e5))
              continue;
            let s5 = i5[t6][4], o5 = this.options.attributeNamePrefix + n6;
            if (n6.length)
              if (this.options.transformAttributeName && (o5 = this.options.transformAttributeName(o5)), "__proto__" === o5 && (o5 = "#__proto__"), void 0 !== s5) {
                ...
                this.options.allowBooleanAttributes && (r5[o5] = true);
          }
        ...
        for (let o5 = 0; o5 < t5.length; o5++)
          if ("<" === t5[o5])
            if ("/" === t5[o5 + 1]) {
              ...
              if (r6 && -1 !== this.options.unpairedTags.indexOf(r6))
                throw new Error(`Unpaired tag can not be used as closing tag: </${r6}>`);
              let l5 = 0;
              ...
              if (this.isItStopNode(this.stopNodesExact, this.stopNodesWildcard, s5, a5)) {
                ...
                if (u5.length > 0 && u5.lastIndexOf("/") === u5.length - 1)
                  "/" === a5[a5.length - 1] ? (a5 = a5.substr(0, a5.length - 1), s5 = s5.substr(0, s5.length - 1), u5 = a5) : u5 = u5.substr(0, u5.length - 1), o5 = r6.closeIndex;
                else if (-1 !== this.options.unpairedTags.indexOf(a5))
                  o5 = r6.closeIndex;
                else {
                  const i6 = this.readStopNodeData(t5, l5, d5 + 1);
                  if (!i6)
                    throw new Error(`Unexpected end of ${l5}`);
      ...
      const B2 = function(t5) {
        if (this.options.processEntities) {
          ...
          if (this.options.htmlEntities)
            for (let e5 in this.htmlEntities) {
        ...
        for (; i5 < t5.length; i5++)
          if ("<" === t5[i5])
            if ("/" === t5[i5 + 1]) {
              ...
              if (t5.substring(i5 + 2, r5).trim() === e5 && (s5--, 0 === s5))
                return { tagContent: t5.substring(n5, i5), i: r5 };
              i5 = r5;
            } else if ("?" === t5[i5 + 1])
              i5 = G2(t5, "?>", i5 + 1, "StopNode is not closed.");
            else if ("!--" === t5.substr(i5 + 1, 3))
              i5 = G2(t5, "-->", i5 + 3, "StopNode is not closed.");
            else if ("![" === t5.substr(i5 + 1, 2))
              i5 = G2(t5, "]]>", i5, "StopNode is not closed.") - 2;
            else {
              const n6 = X(t5, i5, ">");
      ...
      function q4(t5, e5, i5) {
        if (e5 && "string" == typeof t5) {
          ...
          return "true" === e6 || "false" !== e6 && function(t6, e7 = {}) {
            if (e7 = Object.assign({}, C2, e7), !t6 || "string" != typeof t6)
              return t6;
            let i6 = t6.trim();
            if (void 0 !== e7.skipLike && e7.skipLike.test(i6))
              return t6;
            if ("0" === t6)
              return 0;
            if (e7.hex && A2.test(i6))
              return function(t7) {
                if (parseInt)
                  return parseInt(t7, 16);
                if (Number.parseInt)
                  return Number.parseInt(t7, 16);
                if (window && window.parseInt)
                  return window.parseInt(t7, 16);
              ...
              }(t6, i6, e7);
            {
              ...
              if (s5) {
                ...
                if (!e7.leadingZeros && (o5.length > 1 || 1 === o5.length && !l5))
                  return t6;
                {
                  ...
                  if (0 === n6 || -0 === n6)
                    return n6;
                  if (-1 !== s6.search(/[eE]/))
                    return e7.eNotation ? n6 : t6;
                  if (-1 !== i6.indexOf("."))
                    return "0" === s6 || s6 === a5 || s6 === `${r5}${a5}` ? n6 : t6;
                  let l6 = o5 ? a5 : i6;
      ...
      function z2(t5, e5, i5) {
        ...
        for (let r5 = 0; r5 < t5.length; r5++) {
          ...
          let l5 = "";
          if (l5 = void 0 === i5 ? a5 : i5 + "." + a5, a5 === e5.textNodeName)
            void 0 === n5 ? n5 = o5[a5] : n5 += "" + o5[a5];
          else {
            if (void 0 === a5)
              continue;
            if (o5[a5]) {
      ...
      class et {
        ...
        parse(t5, e5) {
          if ("string" != typeof t5 && t5.toString)
            t5 = t5.toString();
          ...
          if (e5) {
            ...
            const i6 = a4(t5, e5);
            if (true !== i6)
              throw Error(`${i6.err.msg}:${i6.err.line}:${i6.err.col}`);
          }
      ...
      function st(t5) {
        ...
        for (let i5 = 0; i5 < e5.length; i5++) {
          const n5 = e5[i5];
          if (t5.hasOwnProperty(n5) && ":@" !== n5)
            return n5;
        }
      }
      function rt(t5, e5) {
        let i5 = "";
        if (t5 && !e5.ignoreAttributes)
          for (let n5 in t5) {
      ...
      function ot(t5, e5) {
        ...
        for (let n5 in e5.stopNodes)
          if (e5.stopNodes[n5] === t5 || e5.stopNodes[n5] === "*." + i5)
            return true;
        return false;
      }
      function at(t5, e5) {
        if (t5 && t5.length > 0 && e5.processEntities)
          for (let i5 = 0; i5 < e5.entities.length; i5++) {
      ...
      ut.prototype.build = function(t5) {
        ...
        for (let o5 in t5)
          if (Object.prototype.hasOwnProperty.call(t5, o5))
            if (void 0 === t5[o5])
              this.isAttribute(o5) && (s5 += "");
            else if (null === t5[o5])
              this.isAttribute(o5) || o5 === this.options.cdataPropName ? s5 += "" : "?" === o5[0] ? s5 += this.indentate(e5) + "<" + o5 + "?" + this.tagEndChar : s5 += this.indentate(e5) + "<" + o5 + "/" + this.tagEndChar;
            else if (t5[o5] instanceof Date)
              s5 += this.buildTextValNode(t5[o5], o5, "", e5);
            else if ("object" != typeof t5[o5]) {
              const i6 = this.isAttribute(o5);
              if (i6 && !this.ignoreAttributesFn(i6, r5))
                n5 += this.buildAttrPairStr(i6, "" + t5[o5]);
              else if (!i6)
                if (o5 === this.options.textNodeName) {
              ...
              for (let l5 = 0; l5 < n6; l5++) {
                ...
                if (void 0 === n7)
                  ...
                  "?" === o5[0] ? s5 += this.indentate(e5) + "<" + o5 + "?" + this.tagEndChar : s5 += this.indentate(e5) + "<" + o5 + "/" + this.tagEndChar;
                else if ("object" == typeof n7)
              ...
              for (let s6 = 0; s6 < i6; s6++)
                n5 += this.buildAttrPairStr(e6[s6], "" + t5[o5][e6[s6]]);
            } else
              s5 += this.processTextOrObjNode(t5[o5], o5, e5, i5);
        ...
        if ("" === t5)
          return "?" === e5[0] ? this.indentate(n5) + "<" + e5 + i5 + "?" + this.tagEndChar : this.indentate(n5) + "<" + e5 + i5 + this.closeTag(e5) + this.tagEndChar;
        {
        ...
        if (false !== this.options.cdataPropName && e5 === this.options.cdataPropName)
          return this.indentate(n5) + `<![CDATA[${t5}]]>` + this.newLine;
        if (false !== this.options.commentPropName && e5 === this.options.commentPropName)
          return this.indentate(n5) + `<!--${t5}-->` + this.newLine;
        if ("?" === e5[0])
          return this.indentate(n5) + "<" + e5 + i5 + "?" + this.tagEndChar;
        {
        ...
        if (t5 && t5.length > 0 && this.options.processEntities)
          for (let e5 = 0; e5 < this.options.entities.length; e5++) {
...
var init_XmlShapeDeserializer = __esm({
  "node_modules/@aws-sdk/core/dist-es/submodules/protocols/xml/XmlShapeDeserializer.js"() {
    ...
    init_protocols();
    init_schema();
    import_smithy_client4 = __toESM(require_dist_cjs19());
...
var init_QueryShapeSerializer = __esm({
  "node_modules/@aws-sdk/core/dist-es/submodules/protocols/query/QueryShapeSerializer.js"() {
    ...
    init_schema();
    init_serde();
    import_smithy_client5 = __toESM(require_dist_cjs19());
...
var init_parseXmlBody = __esm({
  "node_modules/@aws-sdk/core/dist-es/submodules/protocols/xml/parseXmlBody.js"() {
    ...
    import_smithy_client6 = __toESM(require_dist_cjs19());
    init_common();
...
var init_XmlShapeSerializer = __esm({
  "node_modules/@aws-sdk/core/dist-es/submodules/protocols/xml/XmlShapeSerializer.js"() {
    import_xml_builder3 = __toESM(require_dist_cjs28());
    init_protocols();
    init_schema();
    init_serde();
    import_smithy_client7 = __toESM(require_dist_cjs19());
...
var require_dist_cjs34 = __commonJS({
  "node_modules/@smithy/node-config-provider/dist-cjs/index.js"(exports2) {
    "use strict";
    var propertyProvider = require_dist_cjs26();
...
var require_dist_cjs35 = __commonJS({
  "node_modules/@smithy/middleware-endpoint/dist-cjs/index.js"(exports2) {
    ...
    var core = (init_dist_es(), __toCommonJS(dist_es_exports));
    var utilMiddleware = require_dist_cjs17();
    var middlewareSerde = require_dist_cjs21();
...
var require_dist_cjs45 = __commonJS({
  "node_modules/@smithy/util-defaults-mode-node/dist-cjs/index.js"(exports2) {
    "use strict";
    var configResolver = require_dist_cjs31();
    var nodeConfigProvider = require_dist_cjs34();
    var propertyProvider = require_dist_cjs26();
...
var init_endpointResolver = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso-oidc/endpoint/endpointResolver.js"() {
    import_util_endpoints = __toESM(require_dist_cjs25());
    import_util_endpoints2 = __toESM(require_dist_cjs22());
    init_ruleset();
...
var init_runtimeConfig_shared = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso-oidc/runtimeConfig.shared.js"() {
    ...
    init_protocols2();
    init_dist_es();
    import_smithy_client8 = __toESM(require_dist_cjs19());
    import_url_parser = __toESM(require_dist_cjs24());
...
var init_runtimeConfig = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso-oidc/runtimeConfig.js"() {
    ...
    import_smithy_client9 = __toESM(require_dist_cjs19());
...
var init_runtimeExtensions = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso-oidc/runtimeExtensions.js"() {
    ...
    import_smithy_client10 = __toESM(require_dist_cjs19());
...
var init_SSOOIDCClient = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso-oidc/SSOOIDCClient.js"() {
    ...
    import_smithy_client11 = __toESM(require_dist_cjs19());
    init_httpAuthSchemeProvider();
...
var init_SSOOIDCServiceException = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso-oidc/models/SSOOIDCServiceException.js"() {
    import_smithy_client12 = __toESM(require_dist_cjs19());
...
var init_CreateTokenCommand = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso-oidc/commands/CreateTokenCommand.js"() {
    ...
    import_smithy_client13 = __toESM(require_dist_cjs19());
    init_EndpointParameters();
    init_schemas_0();
...
var init_SSOOIDC = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso-oidc/SSOOIDC.js"() {
    import_smithy_client14 = __toESM(require_dist_cjs19());
...
var init_httpAuthSchemeProvider2 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/signin/auth/httpAuthSchemeProvider.js"() {
    init_dist_es2();
    import_util_middleware7 = __toESM(require_dist_cjs17());
...
var init_endpointResolver2 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/signin/endpoint/endpointResolver.js"() {
    import_util_endpoints3 = __toESM(require_dist_cjs25());
    import_util_endpoints4 = __toESM(require_dist_cjs22());
    init_ruleset2();
...
var init_runtimeConfig_shared2 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/signin/runtimeConfig.shared.js"() {
    ...
    init_protocols2();
    init_dist_es();
    import_smithy_client15 = __toESM(require_dist_cjs19());
    import_url_parser2 = __toESM(require_dist_cjs24());
...
var init_runtimeConfig2 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/signin/runtimeConfig.js"() {
    ...
    import_smithy_client16 = __toESM(require_dist_cjs19());
...
var init_runtimeExtensions2 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/signin/runtimeExtensions.js"() {
    ...
    import_smithy_client17 = __toESM(require_dist_cjs19());
...
var init_SigninClient = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/signin/SigninClient.js"() {
    ...
    import_smithy_client18 = __toESM(require_dist_cjs19());
    init_httpAuthSchemeProvider2();
...
var init_SigninServiceException = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/signin/models/SigninServiceException.js"() {
    import_smithy_client19 = __toESM(require_dist_cjs19());
...
var init_CreateOAuth2TokenCommand = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/signin/commands/CreateOAuth2TokenCommand.js"() {
    ...
    import_smithy_client20 = __toESM(require_dist_cjs19());
    init_EndpointParameters2();
    init_schemas_02();
...
var init_Signin = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/signin/Signin.js"() {
    import_smithy_client21 = __toESM(require_dist_cjs19());
...
var init_httpAuthSchemeProvider3 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/auth/httpAuthSchemeProvider.js"() {
    init_dist_es2();
    import_util_middleware8 = __toESM(require_dist_cjs17());
    init_STSClient();
...
var init_endpointResolver3 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/endpoint/endpointResolver.js"() {
    import_util_endpoints5 = __toESM(require_dist_cjs25());
    import_util_endpoints6 = __toESM(require_dist_cjs22());
    init_ruleset3();
...
var init_runtimeConfig_shared3 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/runtimeConfig.shared.js"() {
    ...
    init_protocols2();
    init_dist_es();
    import_smithy_client22 = __toESM(require_dist_cjs19());
    import_url_parser3 = __toESM(require_dist_cjs24());
...
var init_runtimeConfig3 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/runtimeConfig.js"() {
    ...
    import_smithy_client23 = __toESM(require_dist_cjs19());
...
var init_runtimeExtensions3 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/runtimeExtensions.js"() {
    ...
    import_smithy_client24 = __toESM(require_dist_cjs19());
...
var init_STSClient = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/STSClient.js"() {
    ...
    import_middleware_user_agent3 = __toESM(require_dist_cjs29());
    import_config_resolver6 = __toESM(require_dist_cjs31());
    init_dist_es();
    init_schema();
    ...
    import_smithy_client25 = __toESM(require_dist_cjs19());
    init_httpAuthSchemeProvider3();
...
var init_STSServiceException = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/models/STSServiceException.js"() {
    import_smithy_client26 = __toESM(require_dist_cjs19());
...
var init_AssumeRoleCommand = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/commands/AssumeRoleCommand.js"() {
    ...
    import_smithy_client27 = __toESM(require_dist_cjs19());
    init_EndpointParameters3();
    init_schemas_03();
...
var init_AssumeRoleWithWebIdentityCommand = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/commands/AssumeRoleWithWebIdentityCommand.js"() {
    ...
    import_smithy_client28 = __toESM(require_dist_cjs19());
    init_EndpointParameters3();
    init_schemas_03();
...
var init_STS = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/STS.js"() {
    import_smithy_client29 = __toESM(require_dist_cjs19());
  ...
  "node_modules/@aws-sdk/credential-provider-web-identity/dist-cjs/fromWebToken.js"(exports2) {
    ...
    var __importStar2 = exports2 && exports2.__importStar || /* @__PURE__ */ function() {
      ...
      return function(mod) {
        ...
        var result = {};
        if (mod != null) {
          for (var k4 = ownKeys2(mod), i4 = 0; i4 < k4.length; i4++)
            if (k4[i4] !== "default")
              __createBinding2(result, mod, k4[i4]);
        }
...
var require_ruleset2 = __commonJS({
  "node_modules/@aws-sdk/client-sqs/dist-cjs/endpoint/ruleset.js"(exports2) {
    ...
    var s4 = [m4];
    var t4 = [{ [x4]: "Region" }];
    var _data4 = { version: "1.0", parameters: { Region: i4, UseDualStack: j4, UseFIPS: j4, Endpoint: i4 }, rules: [{ conditions: [{ [v4]: b4, [w4]: [k4] }], rules: [{ conditions: r4, error: "Invalid Configuration: FIPS and custom endpoint are not supported", type: d4 }, { conditions: s4, error: "Invalid Configuration: Dualstack and custom endpoint are not supported", type: d4 }, { endpoint: { url: k4, properties: n4, headers: n4 }, type: e4 }], type: f4 }, { conditions: [{ [v4]: b4, [w4]: t4 }], rules: [{ conditions: [{ [v4]: "aws.partition", [w4]: t4, assign: g4 }], rules: [{ conditions: [l4, m4], rules: [{ conditions: [{ [v4]: c4, [w4]: [a4, o4] }, q4], rules: [{ endpoint: { url: "https://sqs-fips.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: n4, headers: n4 }, type: e4 }], type: f4 }, { error: "FIPS and DualStack are enabled, but this partition does not support one or both", type: d4 }], type: f4 }, { conditions: r4, rules: [{ conditions: [{ [v4]: c4, [w4]: [o4, a4] }], rules: [{ conditions: [{ [v4]: "stringEquals", [w4]: [{ [v4]: h4, [w4]: [p4, "name"] }, "aws-us-gov"] }], endpoint: { url: "https://sqs.{Region}.amazonaws.com", properties: n4, headers: n4 }, type: e4 }, { endpoint: { url: "https://sqs-fips.{Region}.{PartitionResult#dnsSuffix}", properties: n4, headers: n4 }, type: e4 }], type: f4 }, { error: "FIPS is enabled but this partition does not support FIPS", type: d4 }], type: f4 }, { conditions: s4, rules: [{ conditions: [q4], rules: [{ endpoint: { url: "https://sqs.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: n4, headers: n4 }, type: e4 }], type: f4 }, { error: "DualStack is enabled but this partition does not support DualStack", type: d4 }], type: f4 }, { endpoint: { url: "https://sqs.{Region}.{PartitionResult#dnsSuffix}", properties: n4, headers: n4 }, type: e4 }], type: f4 }], type: f4 }, { error: "Invalid Configuration: Missing Region", type: d4 }] };
    exports2.ruleSet = _data4;
  }
});
...
var require_dist_cjs55 = __commonJS({
  "node_modules/@aws-sdk/client-sqs/dist-cjs/index.js"(exports2) {
    "use strict";
    var middlewareHostHeader = require_dist_cjs3();
    var middlewareLogger = require_dist_cjs4();
    var middlewareRecursionDetection = require_dist_cjs5();
    var middlewareSdkSqs = require_dist_cjs20();
    var middlewareUserAgent = require_dist_cjs29();
    var configResolver = require_dist_cjs31();
    var core = (init_dist_es(), __toCommonJS(dist_es_exports));
    var schema = (init_schema(), __toCommonJS(schema_exports));
    ...
    var SQSServiceException = class _SQSServiceException extends smithyClient.ServiceException {
      constructor(options) {
        super(options);
    ...
    var _A2 = "Actions";
    var _AN = "ActionName";
    var _ANOMM = "ApproximateNumberOfMessagesMoved";
    var _ANOMTM = "ApproximateNumberOfMessagesToMove";
    var _ANt = "AttributeNames";
    var _ANtt = "AttributeName";
    var _AP = "AddPermission";
    var _APR = "AddPermissionRequest";
    var _AWSAI = "AWSAccountIds";
    var _AWSAIc = "AWSAccountId";
    var _At = "Attributes";
    var _Att = "Attribute";
    var _B = "Body";
    var _BEIND = "BatchEntryIdsNotDistinct";
    var _BL = "BinaryList";
    var _BLV = "BinaryListValues";
    var _BLVi = "BinaryListValue";
    var _BREE = "BatchResultErrorEntry";
    var _BREEL = "BatchResultErrorEntryList";
    var _BRTL = "BatchRequestTooLong";
    var _BV = "BinaryValue";
    var _C2 = "Code";
    var _CMMT = "CancelMessageMoveTask";
    var _CMMTR = "CancelMessageMoveTaskRequest";
    var _CMMTRa = "CancelMessageMoveTaskResult";
    var _CMV = "ChangeMessageVisibility";
    var _CMVB = "ChangeMessageVisibilityBatch";
    var _CMVBR = "ChangeMessageVisibilityBatchRequest";
    var _CMVBRE = "ChangeMessageVisibilityBatchRequestEntry";
    var _CMVBREL = "ChangeMessageVisibilityBatchRequestEntryList";
    var _CMVBRELh = "ChangeMessageVisibilityBatchResultEntryList";
    var _CMVBREh = "ChangeMessageVisibilityBatchResultEntry";
    var _CMVBRh = "ChangeMessageVisibilityBatchResult";
    var _CMVR = "ChangeMessageVisibilityRequest";
    var _CQ = "CreateQueue";
    var _CQR = "CreateQueueRequest";
    var _CQRr = "CreateQueueResult";
    var _DA = "DestinationArn";
    var _DM = "DeleteMessage";
    var _DMB = "DeleteMessageBatch";
    var _DMBR = "DeleteMessageBatchRequest";
    var _DMBRE = "DeleteMessageBatchRequestEntry";
    var _DMBREL = "DeleteMessageBatchRequestEntryList";
    var _DMBRELe = "DeleteMessageBatchResultEntryList";
    var _DMBREe = "DeleteMessageBatchResultEntry";
    var _DMBRe = "DeleteMessageBatchResult";
    var _DMR = "DeleteMessageRequest";
    var _DQ = "DeleteQueue";
    var _DQR = "DeleteQueueRequest";
    var _DS2 = "DelaySeconds";
    var _DT = "DataType";
    var _E2 = "Entries";
    ...
    var _GQU = "GetQueueUrl";
    var _GQUR = "GetQueueUrlRequest";
    var _GQURe = "GetQueueUrlResult";
    var _I = "Id";
    var _IA = "InvalidAddress";
    var _IAN = "InvalidAttributeName";
    var _IAV = "InvalidAttributeValue";
    var _IBEI = "InvalidBatchEntryId";
    var _IIF = "InvalidIdFormat";
    var _IMC = "InvalidMessageContents";
    var _IS = "InvalidSecurity";
    var _K2 = "Key";
    var _KAD = "KmsAccessDenied";
    var _KD = "KmsDisabled";
    var _KIKU = "KmsInvalidKeyUsage";
    var _KIS = "KmsInvalidState";
    var _KNF = "KmsNotFound";
    var _KOIR = "KmsOptInRequired";
    var _KT = "KmsThrottled";
    var _L = "Label";
    var _LDLSQ = "ListDeadLetterSourceQueues";
    var _LDLSQR = "ListDeadLetterSourceQueuesRequest";
    var _LDLSQRi = "ListDeadLetterSourceQueuesResult";
    var _LMMT = "ListMessageMoveTasks";
    var _LMMTR = "ListMessageMoveTasksRequest";
    var _LMMTRE = "ListMessageMoveTasksResultEntry";
    var _LMMTREL = "ListMessageMoveTasksResultEntryList";
    var _LMMTRi = "ListMessageMoveTasksResult";
    var _LQ = "ListQueues";
    var _LQR = "ListQueuesRequest";
    var _LQRi = "ListQueuesResult";
    var _LQT = "ListQueueTags";
    var _LQTR = "ListQueueTagsRequest";
    var _LQTRi = "ListQueueTagsResult";
    var _M = "Message";
    var _MA = "MessageAttributes";
    var _MAN = "MessageAttributeNames";
    var _MANe = "MessageAttributeName";
    var _MAV = "MessageAttributeValue";
    var _MAe = "MessageAttribute";
    var _MB = "MessageBody";
    var _MBAM = "MessageBodyAttributeMap";
    var _MBSAM = "MessageBodySystemAttributeMap";
    var _MDI = "MessageDeduplicationId";
    var _MDOB = "MD5OfBody";
    var _MDOMA = "MD5OfMessageAttributes";
    var _MDOMB = "MD5OfMessageBody";
    var _MDOMSA = "MD5OfMessageSystemAttributes";
    var _MGI = "MessageGroupId";
    var _MI = "MessageId";
    var _ML = "MessageList";
    var _MNI = "MessageNotInflight";
    var _MNOM = "MaxNumberOfMessages";
    var _MNOMPS = "MaxNumberOfMessagesPerSecond";
    var _MR = "MaxResults";
    var _MSA = "MessageSystemAttributes";
    var _MSAM = "MessageSystemAttributeMap";
    var _MSAN = "MessageSystemAttributeNames";
    var _MSAV = "MessageSystemAttributeValue";
    var _MSAe = "MessageSystemAttribute";
    var _Me = "Messages";
    var _N = "Name";
    var _NT = "NextToken";
    var _OL = "OverLimit";
    var _PQ = "PurgeQueue";
    var _PQIP = "PurgeQueueInProgress";
    var _PQR = "PurgeQueueRequest";
    var _QAM = "QueueAttributeMap";
    var _QDNE = "QueueDoesNotExist";
    var _QDR = "QueueDeletedRecently";
    var _QN = "QueueName";
    var _QNE = "QueueNameExists";
    var _QNP = "QueueNamePrefix";
    var _QOAWSAI = "QueueOwnerAWSAccountId";
    var _QU = "QueueUrl";
    var _QUu = "QueueUrls";
    var _R = "Results";
    var _RH = "ReceiptHandle";
    var _RHII = "ReceiptHandleIsInvalid";
    var _RM = "ReceiveMessage";
    var _RMR = "ReceiveMessageRequest";
    var _RMRe = "ReceiveMessageResult";
    var _RNFE = "ResourceNotFoundException";
    var _RP = "RemovePermission";
    var _RPR = "RemovePermissionRequest";
    var _RRAI = "ReceiveRequestAttemptId";
    var _RT3 = "RequestThrottled";
    var _S = "Successful";
    var _SA = "SourceArn";
    var _SF = "SenderFault";
    var _SL = "StringList";
    var _SLV = "StringListValues";
    var _SLVt = "StringListValue";
    var _SM = "SendMessage";
    var _SMB = "SendMessageBatch";
    var _SMBR = "SendMessageBatchRequest";
    var _SMBRE = "SendMessageBatchRequestEntry";
    var _SMBREL = "SendMessageBatchRequestEntryList";
    var _SMBRELe = "SendMessageBatchResultEntryList";
    var _SMBREe = "SendMessageBatchResultEntry";
    var _SMBRe = "SendMessageBatchResult";
    var _SMMT = "StartMessageMoveTask";
    var _SMMTR = "StartMessageMoveTaskRequest";
    var _SMMTRt = "StartMessageMoveTaskResult";
    var _SMR = "SendMessageRequest";
    var _SMRe = "SendMessageResult";
    var _SN2 = "SequenceNumber";
    var _SQA = "SetQueueAttributes";
    var _SQAR = "SetQueueAttributesRequest";
    var _ST2 = "StartedTimestamp";
    var _SV = "StringValue";
    var _St = "Status";
    var _T2 = "Tag";
    var _TH = "TaskHandle";
    ...
    var _TKa = "TagKey";
    var _TM = "TagMap";
    var _TMEIBR = "TooManyEntriesInBatchRequest";
    var _TQ = "TagQueue";
    var _TQR = "TagQueueRequest";
    var _Ta2 = "Tags";
    var _UO = "UnsupportedOperation";
    var _UQ = "UntagQueue";
    var _UQR = "UntagQueueRequest";
    var _V2 = "Value";
    var _VT = "VisibilityTimeout";
    ...
    var _m3 = "message";
    var _qU = "queueUrls";
    var _s4 = "smithy.ts.sdk.synthetic.com.amazonaws.sqs";
    var _t = "tags";
    var _xF = "xmlFlattened";
    var _xN = "xmlName";
    var n04 = "com.amazonaws.sqs";
    ...
    var BatchEntryIdsNotDistinct$ = [
      ...
      n04,
      _BEIND,
      { [_aQE2]: [`AWS.SimpleQueueService.BatchEntryIdsNotDistinct`, 400], [_e4]: _c4, [_hE4]: 400 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(BatchEntryIdsNotDistinct$, BatchEntryIdsNotDistinct);
    var BatchRequestTooLong$ = [
      -3,
      n04,
      _BRTL,
      { [_aQE2]: [`AWS.SimpleQueueService.BatchRequestTooLong`, 400], [_e4]: _c4, [_hE4]: 400 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(BatchRequestTooLong$, BatchRequestTooLong);
    ...
    var CancelMessageMoveTaskRequest$ = [
      3,
      n04,
      _CMMTR,
      0,
    ...
    var CancelMessageMoveTaskResult$ = [
      3,
      n04,
      _CMMTRa,
      0,
    ...
    var CreateQueueRequest$ = [
      ...
      0,
      [_QN, _At, _t],
      [0, [() => QueueAttributeMap, { [_xF]: 1, [_xN]: _Att }], [() => TagMap, { [_xF]: 1, [_xN]: _T2 }]],
      1
    ];
    ...
    var EmptyBatchRequest$ = [
      ...
      n04,
      _EBR,
      { [_aQE2]: [`AWS.SimpleQueueService.EmptyBatchRequest`, 400], [_e4]: _c4, [_hE4]: 400 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(EmptyBatchRequest$, EmptyBatchRequest);
    ...
    var InvalidAddress$ = [
      ...
      n04,
      _IA,
      { [_aQE2]: [`InvalidAddress`, 404], [_e4]: _c4, [_hE4]: 404 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(InvalidAddress$, InvalidAddress);
    ...
    schema.TypeRegistry.for(n04).registerError(InvalidAttributeName$, InvalidAttributeName);
    ...
    schema.TypeRegistry.for(n04).registerError(InvalidAttributeValue$, InvalidAttributeValue);
    var InvalidBatchEntryId$ = [
      -3,
      n04,
      _IBEI,
      { [_aQE2]: [`AWS.SimpleQueueService.InvalidBatchEntryId`, 400], [_e4]: _c4, [_hE4]: 400 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(InvalidBatchEntryId$, InvalidBatchEntryId);
    var InvalidIdFormat$ = [
      -3,
      n04,
      _IIF,
    ...
    schema.TypeRegistry.for(n04).registerError(InvalidIdFormat$, InvalidIdFormat);
    ...
    schema.TypeRegistry.for(n04).registerError(InvalidMessageContents$, InvalidMessageContents);
    var InvalidSecurity$ = [
      -3,
      n04,
      _IS,
      { [_aQE2]: [`InvalidSecurity`, 403], [_e4]: _c4, [_hE4]: 403 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(InvalidSecurity$, InvalidSecurity);
    var KmsAccessDenied$ = [
      -3,
      n04,
      _KAD,
      { [_aQE2]: [`KMS.AccessDeniedException`, 400], [_e4]: _c4, [_hE4]: 400 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(KmsAccessDenied$, KmsAccessDenied);
    var KmsDisabled$ = [
      -3,
      n04,
      _KD,
      { [_aQE2]: [`KMS.DisabledException`, 400], [_e4]: _c4, [_hE4]: 400 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(KmsDisabled$, KmsDisabled);
    var KmsInvalidKeyUsage$ = [
      -3,
      n04,
      _KIKU,
      { [_aQE2]: [`KMS.InvalidKeyUsageException`, 400], [_e4]: _c4, [_hE4]: 400 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(KmsInvalidKeyUsage$, KmsInvalidKeyUsage);
    var KmsInvalidState$ = [
      -3,
      n04,
      _KIS,
      { [_aQE2]: [`KMS.InvalidStateException`, 400], [_e4]: _c4, [_hE4]: 400 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(KmsInvalidState$, KmsInvalidState);
    var KmsNotFound$ = [
      -3,
      n04,
      _KNF,
      { [_aQE2]: [`KMS.NotFoundException`, 400], [_e4]: _c4, [_hE4]: 400 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(KmsNotFound$, KmsNotFound);
    var KmsOptInRequired$ = [
      -3,
      n04,
      _KOIR,
      { [_aQE2]: [`KMS.OptInRequired`, 403], [_e4]: _c4, [_hE4]: 403 },
      [_m3],
      [0]
    ];
    ...
    var KmsThrottled$ = [
      ...
      n04,
      _KT,
      { [_aQE2]: [`KMS.ThrottlingException`, 400], [_e4]: _c4, [_hE4]: 400 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(KmsThrottled$, KmsThrottled);
    ...
    var ListMessageMoveTasksRequest$ = [
      3,
      n04,
      _LMMTR,
      0,
    ...
    var ListMessageMoveTasksResultEntry$ = [
      ...
      _LMMTRE,
      0,
      [_TH, _St, _SA, _DA, _MNOMPS, _ANOMM, _ANOMTM, _FR, _ST2],
      [0, 0, 0, 0, 1, 1, 1, 0, 1]
    ];
    ...
    var MessageAttributeValue$ = [
      ...
      [0, 0, 21, [() => StringList, { [_xF]: 1, [_xN]: _SLVt }], [() => BinaryList, { [_xF]: 1, [_xN]: _BLVi }]],
      1
    ];
    var MessageNotInflight$ = [
      ...
      n04,
      _MNI,
      { [_aQE2]: [`AWS.SimpleQueueService.MessageNotInflight`, 400], [_e4]: _c4, [_hE4]: 400 },
      [],
      []
    ];
    schema.TypeRegistry.for(n04).registerError(MessageNotInflight$, MessageNotInflight);
    ...
    var OverLimit$ = [
      ...
      n04,
      _OL,
      { [_aQE2]: [`OverLimit`, 403], [_e4]: _c4, [_hE4]: 403 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(OverLimit$, OverLimit);
    var PurgeQueueInProgress$ = [
      -3,
      n04,
      _PQIP,
      { [_aQE2]: [`AWS.SimpleQueueService.PurgeQueueInProgress`, 403], [_e4]: _c4, [_hE4]: 403 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(PurgeQueueInProgress$, PurgeQueueInProgress);
    ...
    var QueueDeletedRecently$ = [
      ...
      n04,
      _QDR,
      { [_aQE2]: [`AWS.SimpleQueueService.QueueDeletedRecently`, 400], [_e4]: _c4, [_hE4]: 400 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(QueueDeletedRecently$, QueueDeletedRecently);
    var QueueDoesNotExist$ = [
      -3,
      n04,
      _QDNE,
      { [_aQE2]: [`AWS.SimpleQueueService.NonExistentQueue`, 400], [_e4]: _c4, [_hE4]: 400 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(QueueDoesNotExist$, QueueDoesNotExist);
    var QueueNameExists$ = [
      -3,
      n04,
      _QNE,
      { [_aQE2]: [`QueueAlreadyExists`, 400], [_e4]: _c4, [_hE4]: 400 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(QueueNameExists$, QueueNameExists);
    var ReceiptHandleIsInvalid$ = [
      -3,
      n04,
      _RHII,
      { [_aQE2]: [`ReceiptHandleIsInvalid`, 404], [_e4]: _c4, [_hE4]: 404 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(ReceiptHandleIsInvalid$, ReceiptHandleIsInvalid);
    ...
    var RequestThrottled$ = [
      ...
      n04,
      _RT3,
      { [_aQE2]: [`RequestThrottled`, 403], [_e4]: _c4, [_hE4]: 403 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(RequestThrottled$, RequestThrottled);
    var ResourceNotFoundException$ = [
      -3,
      n04,
      _RNFE,
      { [_aQE2]: [`ResourceNotFoundException`, 404], [_e4]: _c4, [_hE4]: 404 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(ResourceNotFoundException$, ResourceNotFoundException);
    ...
    var SendMessageBatchRequestEntry$ = [
      ...
      _SMBRE,
      0,
      [_I, _MB, _DS2, _MA, _MSA, _MDI, _MGI],
    ...
    var SendMessageBatchResultEntry$ = [
      ...
      _SMBREe,
      0,
      [_I, _MI, _MDOMB, _MDOMA, _MDOMSA, _SN2],
      [0, 0, 0, 0, 0, 0],
      3
    ];
    var SendMessageRequest$ = [
      ...
      _SMR,
      0,
      [_QU, _MB, _DS2, _MA, _MSA, _MDI, _MGI],
      [0, 0, 1, [() => MessageBodyAttributeMap, { [_xF]: 1, [_xN]: _MAe }], [() => MessageBodySystemAttributeMap, { [_xF]: 1, [_xN]: _MSAe }], 0, 0],
      2
    ];
    var SendMessageResult$ = [
      ...
      _SMRe,
      0,
      [_MDOMB, _MDOMA, _MDOMSA, _MI, _SN2],
      [0, 0, 0, 0, 0]
    ];
    ...
    var StartMessageMoveTaskRequest$ = [
      3,
      n04,
      _SMMTR,
      0,
    ...
    var StartMessageMoveTaskResult$ = [
      3,
      n04,
      _SMMTRt,
      0,
    ...
    var TooManyEntriesInBatchRequest$ = [
      ...
      n04,
      _TMEIBR,
      { [_aQE2]: [`AWS.SimpleQueueService.TooManyEntriesInBatchRequest`, 400], [_e4]: _c4, [_hE4]: 400 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(TooManyEntriesInBatchRequest$, TooManyEntriesInBatchRequest);
    var UnsupportedOperation$ = [
      -3,
      n04,
      _UO,
      { [_aQE2]: [`AWS.SimpleQueueService.UnsupportedOperation`, 400], [_e4]: _c4, [_hE4]: 400 },
      [_m3],
      [0]
    ];
    schema.TypeRegistry.for(n04).registerError(UnsupportedOperation$, UnsupportedOperation);
    ...
    var __Unit = "unit";
    var SQSServiceException$ = [-3, _s4, "SQSServiceException", 0, [], []];
    schema.TypeRegistry.for(_s4).registerError(SQSServiceException$, SQSServiceException);
    var BatchResultErrorEntryList = [
      1,
      n04,
      _BREEL,
      0,
    ...
    var SendMessageBatchResultEntryList = [
      1,
      n04,
      _SMBRELe,
      0,
    ...
    var AddPermissionCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "AddPermission", {}).n("SQSClient", "AddPermissionCommand").sc(AddPermission$).build() {
    };
    var CancelMessageMoveTaskCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "CancelMessageMoveTask", {}).n("SQSClient", "CancelMessageMoveTaskCommand").sc(CancelMessageMoveTask$).build() {
    };
    var ChangeMessageVisibilityBatchCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "ChangeMessageVisibilityBatch", {}).n("SQSClient", "ChangeMessageVisibilityBatchCommand").sc(ChangeMessageVisibilityBatch$).build() {
    };
    var ChangeMessageVisibilityCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "ChangeMessageVisibility", {}).n("SQSClient", "ChangeMessageVisibilityCommand").sc(ChangeMessageVisibility$).build() {
    };
    var CreateQueueCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "CreateQueue", {}).n("SQSClient", "CreateQueueCommand").sc(CreateQueue$).build() {
    };
    var DeleteMessageBatchCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "DeleteMessageBatch", {}).n("SQSClient", "DeleteMessageBatchCommand").sc(DeleteMessageBatch$).build() {
    };
    var DeleteMessageCommand2 = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "DeleteMessage", {}).n("SQSClient", "DeleteMessageCommand").sc(DeleteMessage$).build() {
    };
    var DeleteQueueCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "DeleteQueue", {}).n("SQSClient", "DeleteQueueCommand").sc(DeleteQueue$).build() {
    };
    var GetQueueAttributesCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "GetQueueAttributes", {}).n("SQSClient", "GetQueueAttributesCommand").sc(GetQueueAttributes$).build() {
    };
    var GetQueueUrlCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "GetQueueUrl", {}).n("SQSClient", "GetQueueUrlCommand").sc(GetQueueUrl$).build() {
    };
    var ListDeadLetterSourceQueuesCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "ListDeadLetterSourceQueues", {}).n("SQSClient", "ListDeadLetterSourceQueuesCommand").sc(ListDeadLetterSourceQueues$).build() {
    };
    var ListMessageMoveTasksCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "ListMessageMoveTasks", {}).n("SQSClient", "ListMessageMoveTasksCommand").sc(ListMessageMoveTasks$).build() {
    };
    var ListQueuesCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "ListQueues", {}).n("SQSClient", "ListQueuesCommand").sc(ListQueues$).build() {
    };
    var ListQueueTagsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "ListQueueTags", {}).n("SQSClient", "ListQueueTagsCommand").sc(ListQueueTags$).build() {
    };
    var PurgeQueueCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "PurgeQueue", {}).n("SQSClient", "PurgeQueueCommand").sc(PurgeQueue$).build() {
    };
    var ReceiveMessageCommand2 = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions()),
        middlewareSdkSqs.getReceiveMessagePlugin(config)
      ];
    }).s("AmazonSQS", "ReceiveMessage", {}).n("SQSClient", "ReceiveMessageCommand").sc(ReceiveMessage$).build() {
    };
    var RemovePermissionCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "RemovePermission", {}).n("SQSClient", "RemovePermissionCommand").sc(RemovePermission$).build() {
    };
    var SendMessageBatchCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions()),
        middlewareSdkSqs.getSendMessageBatchPlugin(config)
      ];
    }).s("AmazonSQS", "SendMessageBatch", {}).n("SQSClient", "SendMessageBatchCommand").sc(SendMessageBatch$).build() {
    };
    var SendMessageCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions()),
        middlewareSdkSqs.getSendMessagePlugin(config)
      ];
    }).s("AmazonSQS", "SendMessage", {}).n("SQSClient", "SendMessageCommand").sc(SendMessage$).build() {
    };
    var SetQueueAttributesCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "SetQueueAttributes", {}).n("SQSClient", "SetQueueAttributesCommand").sc(SetQueueAttributes$).build() {
    };
    var StartMessageMoveTaskCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "StartMessageMoveTask", {}).n("SQSClient", "StartMessageMoveTaskCommand").sc(StartMessageMoveTask$).build() {
    };
    var TagQueueCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonSQS", "TagQueue", {}).n("SQSClient", "TagQueueCommand").sc(TagQueue$).build() {
    };
    var UntagQueueCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    ...
    var commands4 = {
      ...
      PurgeQueueCommand,
      ReceiveMessageCommand: ReceiveMessageCommand2,
    ...
    exports2.BatchEntryIdsNotDistinct = BatchEntryIdsNotDistinct;
    exports2.BatchEntryIdsNotDistinct$ = BatchEntryIdsNotDistinct$;
    exports2.BatchRequestTooLong = BatchRequestTooLong;
    exports2.BatchRequestTooLong$ = BatchRequestTooLong$;
    exports2.BatchResultErrorEntry$ = BatchResultErrorEntry$;
    exports2.CancelMessageMoveTask$ = CancelMessageMoveTask$;
    exports2.CancelMessageMoveTaskCommand = CancelMessageMoveTaskCommand;
    exports2.CancelMessageMoveTaskRequest$ = CancelMessageMoveTaskRequest$;
    exports2.CancelMessageMoveTaskResult$ = CancelMessageMoveTaskResult$;
    exports2.ChangeMessageVisibility$ = ChangeMessageVisibility$;
    exports2.ChangeMessageVisibilityBatch$ = ChangeMessageVisibilityBatch$;
    exports2.ChangeMessageVisibilityBatchCommand = ChangeMessageVisibilityBatchCommand;
    exports2.ChangeMessageVisibilityBatchRequest$ = ChangeMessageVisibilityBatchRequest$;
    exports2.ChangeMessageVisibilityBatchRequestEntry$ = ChangeMessageVisibilityBatchRequestEntry$;
    exports2.ChangeMessageVisibilityBatchResult$ = ChangeMessageVisibilityBatchResult$;
    exports2.ChangeMessageVisibilityBatchResultEntry$ = ChangeMessageVisibilityBatchResultEntry$;
    exports2.ChangeMessageVisibilityCommand = ChangeMessageVisibilityCommand;
    exports2.ChangeMessageVisibilityRequest$ = ChangeMessageVisibilityRequest$;
    exports2.CreateQueue$ = CreateQueue$;
    exports2.CreateQueueCommand = CreateQueueCommand;
    exports2.CreateQueueRequest$ = CreateQueueRequest$;
    exports2.CreateQueueResult$ = CreateQueueResult$;
    exports2.DeleteMessage$ = DeleteMessage$;
    exports2.DeleteMessageBatch$ = DeleteMessageBatch$;
    exports2.DeleteMessageBatchCommand = DeleteMessageBatchCommand;
    exports2.DeleteMessageBatchRequest$ = DeleteMessageBatchRequest$;
    exports2.DeleteMessageBatchRequestEntry$ = DeleteMessageBatchRequestEntry$;
    exports2.DeleteMessageBatchResult$ = DeleteMessageBatchResult$;
    exports2.DeleteMessageBatchResultEntry$ = DeleteMessageBatchResultEntry$;
    exports2.DeleteMessageCommand = DeleteMessageCommand2;
    exports2.DeleteMessageRequest$ = DeleteMessageRequest$;
    exports2.DeleteQueue$ = DeleteQueue$;
    exports2.DeleteQueueCommand = DeleteQueueCommand;
    exports2.DeleteQueueRequest$ = DeleteQueueRequest$;
    exports2.EmptyBatchRequest = EmptyBatchRequest;
    exports2.EmptyBatchRequest$ = EmptyBatchRequest$;
    exports2.GetQueueAttributes$ = GetQueueAttributes$;
    exports2.GetQueueAttributesCommand = GetQueueAttributesCommand;
    ...
    exports2.GetQueueUrlCommand = GetQueueUrlCommand;
    exports2.GetQueueUrlRequest$ = GetQueueUrlRequest$;
    exports2.GetQueueUrlResult$ = GetQueueUrlResult$;
    exports2.InvalidAddress = InvalidAddress;
    exports2.InvalidAddress$ = InvalidAddress$;
    exports2.InvalidAttributeName = InvalidAttributeName;
    exports2.InvalidAttributeName$ = InvalidAttributeName$;
    exports2.InvalidAttributeValue = InvalidAttributeValue;
    exports2.InvalidAttributeValue$ = InvalidAttributeValue$;
    exports2.InvalidBatchEntryId = InvalidBatchEntryId;
    exports2.InvalidBatchEntryId$ = InvalidBatchEntryId$;
    exports2.InvalidIdFormat = InvalidIdFormat;
    exports2.InvalidIdFormat$ = InvalidIdFormat$;
    exports2.InvalidMessageContents = InvalidMessageContents;
    exports2.InvalidMessageContents$ = InvalidMessageContents$;
    exports2.InvalidSecurity = InvalidSecurity;
    exports2.InvalidSecurity$ = InvalidSecurity$;
    exports2.KmsAccessDenied = KmsAccessDenied;
    exports2.KmsAccessDenied$ = KmsAccessDenied$;
    exports2.KmsDisabled = KmsDisabled;
    exports2.KmsDisabled$ = KmsDisabled$;
    exports2.KmsInvalidKeyUsage = KmsInvalidKeyUsage;
    exports2.KmsInvalidKeyUsage$ = KmsInvalidKeyUsage$;
    exports2.KmsInvalidState = KmsInvalidState;
    exports2.KmsInvalidState$ = KmsInvalidState$;
    exports2.KmsNotFound = KmsNotFound;
    exports2.KmsNotFound$ = KmsNotFound$;
    exports2.KmsOptInRequired = KmsOptInRequired;
    exports2.KmsOptInRequired$ = KmsOptInRequired$;
    exports2.KmsThrottled = KmsThrottled;
    exports2.KmsThrottled$ = KmsThrottled$;
    exports2.ListDeadLetterSourceQueues$ = ListDeadLetterSourceQueues$;
    exports2.ListDeadLetterSourceQueuesCommand = ListDeadLetterSourceQueuesCommand;
    exports2.ListDeadLetterSourceQueuesRequest$ = ListDeadLetterSourceQueuesRequest$;
    exports2.ListDeadLetterSourceQueuesResult$ = ListDeadLetterSourceQueuesResult$;
    exports2.ListMessageMoveTasks$ = ListMessageMoveTasks$;
    exports2.ListMessageMoveTasksCommand = ListMessageMoveTasksCommand;
    exports2.ListMessageMoveTasksRequest$ = ListMessageMoveTasksRequest$;
    exports2.ListMessageMoveTasksResult$ = ListMessageMoveTasksResult$;
    exports2.ListMessageMoveTasksResultEntry$ = ListMessageMoveTasksResultEntry$;
    exports2.ListQueueTags$ = ListQueueTags$;
    exports2.ListQueueTagsCommand = ListQueueTagsCommand;
    exports2.ListQueueTagsRequest$ = ListQueueTagsRequest$;
    exports2.ListQueueTagsResult$ = ListQueueTagsResult$;
    exports2.ListQueues$ = ListQueues$;
    exports2.ListQueuesCommand = ListQueuesCommand;
    exports2.ListQueuesRequest$ = ListQueuesRequest$;
    exports2.ListQueuesResult$ = ListQueuesResult$;
    exports2.Message$ = Message$;
    exports2.MessageAttributeValue$ = MessageAttributeValue$;
    exports2.MessageNotInflight = MessageNotInflight;
    exports2.MessageNotInflight$ = MessageNotInflight$;
    exports2.MessageSystemAttributeName = MessageSystemAttributeName;
    exports2.MessageSystemAttributeNameForSends = MessageSystemAttributeNameForSends;
    exports2.MessageSystemAttributeValue$ = MessageSystemAttributeValue$;
    exports2.OverLimit = OverLimit;
    exports2.OverLimit$ = OverLimit$;
    exports2.PurgeQueue$ = PurgeQueue$;
    exports2.PurgeQueueCommand = PurgeQueueCommand;
    exports2.PurgeQueueInProgress = PurgeQueueInProgress;
    exports2.PurgeQueueInProgress$ = PurgeQueueInProgress$;
    exports2.PurgeQueueRequest$ = PurgeQueueRequest$;
    exports2.QueueAttributeName = QueueAttributeName;
    exports2.QueueDeletedRecently = QueueDeletedRecently;
    exports2.QueueDeletedRecently$ = QueueDeletedRecently$;
    exports2.QueueDoesNotExist = QueueDoesNotExist;
    exports2.QueueDoesNotExist$ = QueueDoesNotExist$;
    exports2.QueueNameExists = QueueNameExists;
    exports2.QueueNameExists$ = QueueNameExists$;
    exports2.ReceiptHandleIsInvalid = ReceiptHandleIsInvalid;
    exports2.ReceiptHandleIsInvalid$ = ReceiptHandleIsInvalid$;
    exports2.ReceiveMessage$ = ReceiveMessage$;
    exports2.ReceiveMessageCommand = ReceiveMessageCommand2;
    exports2.ReceiveMessageRequest$ = ReceiveMessageRequest$;
    exports2.ReceiveMessageResult$ = ReceiveMessageResult$;
    ...
    exports2.RequestThrottled = RequestThrottled;
    exports2.RequestThrottled$ = RequestThrottled$;
    exports2.ResourceNotFoundException = ResourceNotFoundException;
    exports2.ResourceNotFoundException$ = ResourceNotFoundException$;
    exports2.SQS = SQS;
    ...
    exports2.SendMessageBatch$ = SendMessageBatch$;
    exports2.SendMessageBatchCommand = SendMessageBatchCommand;
    exports2.SendMessageBatchRequest$ = SendMessageBatchRequest$;
    exports2.SendMessageBatchRequestEntry$ = SendMessageBatchRequestEntry$;
    exports2.SendMessageBatchResult$ = SendMessageBatchResult$;
    exports2.SendMessageBatchResultEntry$ = SendMessageBatchResultEntry$;
    exports2.SendMessageCommand = SendMessageCommand;
    exports2.SendMessageRequest$ = SendMessageRequest$;
    exports2.SendMessageResult$ = SendMessageResult$;
    exports2.SetQueueAttributes$ = SetQueueAttributes$;
    exports2.SetQueueAttributesCommand = SetQueueAttributesCommand;
    exports2.SetQueueAttributesRequest$ = SetQueueAttributesRequest$;
    exports2.StartMessageMoveTask$ = StartMessageMoveTask$;
    exports2.StartMessageMoveTaskCommand = StartMessageMoveTaskCommand;
    exports2.StartMessageMoveTaskRequest$ = StartMessageMoveTaskRequest$;
    exports2.StartMessageMoveTaskResult$ = StartMessageMoveTaskResult$;
    exports2.TagQueue$ = TagQueue$;
    exports2.TagQueueCommand = TagQueueCommand;
    exports2.TagQueueRequest$ = TagQueueRequest$;
    exports2.TooManyEntriesInBatchRequest = TooManyEntriesInBatchRequest;
    exports2.TooManyEntriesInBatchRequest$ = TooManyEntriesInBatchRequest$;
    exports2.UnsupportedOperation = UnsupportedOperation;
    exports2.UnsupportedOperation$ = UnsupportedOperation$;
    exports2.UntagQueue$ = UntagQueue$;
    exports2.UntagQueueCommand = UntagQueueCommand;
    exports2.UntagQueueRequest$ = UntagQueueRequest$;
    exports2.paginateListDeadLetterSourceQueues = paginateListDeadLetterSourceQueues;
    exports2.paginateListQueues = paginateListQueues;
  }
});

// app/index.ts
var import_client_sqs = __toESM(require_dist_cjs55());
...
async function processMessage(messageBody) {
  ...
  const data2 = JSON.parse(messageBody);
...
async function pollMessages() {
  ...
  while (true) {
    try {
      ...
      console.error("Error polling SQS:", error2);
      await new Promise((resolve) => setTimeout(resolve, 5e3));
    }
  }
}
pollMessages().catch((error2) => {
